...
% dataType = 'Analog1k'; % dataType can be:
                    % Neural - 'Spike','LFP', 'Hi-Res', or 'Raw'; 
                    % Stim - 'Stim'
                    % Analog I/O - 'Analog 30k' or 'Analog 1k'
                    % Digital I/O - 'Digital'
                    
% dataChannel = 10246;   % A-1 starts at 1, A-2 starts at 33, 
                   % B-1 starts at 129
...
% completeFilePath = 'K:\Monkey TDT\Rocky_baseline\continuous Blackrock\';
...
% save(['e-evokedSW_stim_analog1k',num2str(dataChannel),'.mat'])
